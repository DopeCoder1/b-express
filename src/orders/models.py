...
STATUS_GROUPS = {
    "PENDING": [OrderStatus.ASSIGNED_TO_COURIER, OrderStatus.COURIER_DELIVERING_TO_WAREHOUSE, OrderStatus.ACCEPTED_TO_WAREHOUSE, OrderStatus.CLIENT_DELIVERING_TO_WAREHOUSE, OrderStatus.CREATED],
